...
export const exercises = [
  ...
  // ── GYM - PUSH (Chest, Shoulders, Triceps) ─────────────────────────────────
  {
    ...
    description:
      "Lie on bench, grip bar slightly wider than shoulder width. Lower to chest, press up. Control the descent.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 8,
  ...
  },
  {
    ...
    description:
      "Set bench to 30-45°. Press dumbbells from chest level to full extension. Squeeze at top.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Dumbbell Flyes",
    description:
      "Lie flat, arms extended above chest. Lower dumbbells in an arc until you feel a stretch, then squeeze back up.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Overhead Press",
    description:
      "Standing or seated, press barbell or dumbbells from shoulder level to overhead. Keep core tight.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Lateral Raises",
    description:
      "Stand with dumbbells at sides. Raise arms out to sides until parallel to floor. Control the descent.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    description:
      "Using cable machine, push rope or bar down until arms are fully extended. Keep elbows pinned to sides.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    description:
      "Lean forward on dip bars. Lower until you feel chest stretch, push back up. Add weight if needed.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Cable Flyes",
    description:
      "Set cables at chest height. Step forward, bring handles together in front of chest with slight bend in elbows.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    description:
      "Grip bar shoulder-width apart. Lower to lower chest, press up. Emphasizes triceps.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Arnold Press",
    description:
      "Start with palms facing you at shoulder level. Rotate palms outward as you press overhead.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Skull Crushers",
    description:
      "Lie on bench with EZ bar or dumbbells. Lower weight to forehead by bending elbows, extend back up.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    description:
      "Standard, diamond, wide, or decline push-ups. Great burnout exercise at the end of push day.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  // ── GYM - PULL (Back, Biceps, Rear Delts) ──────────────────────────────────
  {
    id: "gym-pull-001",
    name: "Pull-ups / Lat Pulldown",
    description:
      "Grip bar wider than shoulders. Pull until chin clears bar or bar reaches chest. Control the negative.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Barbell Rows",
    description:
      "Hinge at hips, pull bar to lower chest/upper abs. Squeeze shoulder blades together at top.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    description:
      "Sit upright, pull handle to lower chest. Keep back straight, squeeze at the contraction.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Dumbbell Rows",
    description:
      "One arm on bench for support. Pull dumbbell to hip, squeezing lat at top. Control the descent.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Face Pulls",
    description:
      "Cable at face height. Pull rope to face, externally rotating shoulders. Great for rear delts and posture.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Hammer Curls",
    description:
      "Neutral grip (palms facing each other). Curl dumbbells to shoulders. Targets brachialis and forearms.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
    ...
    equipment: ["none"],
    injuryRisk: [],
    focus: ["biceps", "brachialis", "forearms"],
    defaultSets: 3,
    defaultReps: 12,
  },
  {
    ...
    name: "Deadlifts",
    description:
      "Hinge at hips, grip bar, drive through floor. Keep back flat, chest up. Full body compound lift.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 8,
    ...
    equipment: ["none"],
    injuryRisk: ["back"],
    focus: ["back", "hamstrings", "glutes", "traps"],
    defaultSets: 4,
    defaultReps: 6,
  },
  {
  ...
  },
  {
    ...
    description:
      "Bent over or on incline bench. Raise dumbbells out to sides, squeezing rear delts.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    description:
      "Sit on incline bench, let arms hang. Curl with stretch at bottom for full range bicep work.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Shrugs",
    description:
      "Hold heavy dumbbells or barbell. Shrug shoulders straight up toward ears, squeeze at top.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
    ...
    equipment: ["none"],
    injuryRisk: [],
    focus: ["traps", "upper back"],
    defaultSets: 3,
    defaultReps: 12,
  },

  // ── GYM - LEGS (Quads, Hamstrings, Glutes, Calves) ─────────────────────────
  {
    id: "gym-legs-001",
    name: "Barbell Squats",
    description:
      "Bar on upper back, feet shoulder-width. Squat until thighs parallel or below. Drive through heels.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 8,
  ...
  },
  {
    ...
    description:
      "Slight knee bend, hinge at hips pushing butt back. Feel hamstring stretch, squeeze glutes at top.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Leg Press",
    description:
      "Feet shoulder-width on platform. Lower until 90° knee bend, press back up without locking out.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Walking Lunges",
    description:
      "Step forward into lunge, knee over ankle. Push through front heel, step forward with back leg.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Leg Extensions",
    description:
      "Seated machine. Extend legs until straight, squeeze quads at top. Control the descent.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Hip Thrusts",
    description:
      "Upper back on bench, barbell across hips. Drive hips up, squeeze glutes at top. Control descent.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    description:
      "Rear foot elevated on bench. Lower until front thigh parallel, drive through front heel.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Calf Raises",
    description:
      "Standing or seated. Rise onto toes, squeeze calves at top. Full stretch at bottom.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Goblet Squats",
    description:
      "Hold dumbbell at chest. Squat deep with elbows tracking inside knees. Great for beginners.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate"],
    durationMin: 5,
  ...
  },
  {
    ...
    name: "Hack Squats",
    description:
      "Machine squat variation. Feet forward on platform, squat down keeping back against pad.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    name: "Good Mornings",
    description:
      "Bar on upper back, hinge at hips with slight knee bend. Feel hamstring stretch, return upright.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 5,
  ...
  // ─── RCP-Split program additions ──────────────────────────────────────────
  {
    id: "gym-pull-013",
    name: "Pendlay Row",
    description:
      "Explosive barbell row from a dead stop on the floor each rep. Flat back, pull to lower chest, reset between reps.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 6,
  ...
  },
  {
    ...
    description:
      "Standing, arms nearly straight, pull a high cable down in an arc to the hips. Isolates the lats with a big stretch.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 4,
  ...
  },
  {
    ...
    description:
      "Upper arm braced on a preacher bench, curl a dumbbell through a full range. Strict, no swinging.",
    category: "gym-pull",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 4,
  ...
  },
  {
    ...
    description:
      "Pull a barbell up the front of the body to upper-chest height, elbows leading. Builds delts and traps.",
    category: "gym-push",
    wallTypes: ["any"],
    levels: ["intermediate", "advanced"],
    durationMin: 4,
  ...
  },
  {
    ...
    description:
      "Seated with weight on the knees (or in a calf-press / leg-press machine). Rise onto toes, full stretch at the bottom. Targets the soleus.",
    category: "gym-legs",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 4,
  ...
  },
  {
    ...
    name: "Crunch Machine",
    description:
      "Seated ab-crunch machine. Curl the torso against the resistance, squeeze the abs, control the return.",
    category: "core",
    wallTypes: ["any"],
    levels: ["beginner", "intermediate", "advanced"],
    durationMin: 3,
