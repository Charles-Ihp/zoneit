      ...
      {!user && !authLoading ? (
        ...
        >
          ...
          <div className="mt-10 border-t border-border pt-6">
            ...
            <button
              onClick={logout}
              className="mt-3 rounded-xl border border-border px-4 py-2 text-sm font-medium text-muted-foreground transition-colors hover:border-destructive/50 hover:text-destructive"
            >
              Sign out
            </button>
          </div>
